...
function renderList() {
    ...
    todoList.forEach((item, index) => {
        ...
        const deleteIcon = document.createElement('img'); deleteIcon.src = 'icon-delet.png';
        ...
        const editIcon = document.createElement('img'); editIcon.src = 'icon-edit.png';
        const editText = document.createElement('span');
        editText.innerText = 'Edite';
